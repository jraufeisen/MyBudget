...
class AccountSelectionController: WKInterfaceController {
    ...
    override func awake(withContext context: Any?) {
        ...
        case .Income:
            ...
            income_string.append(NSAttributedString.init(string: "\(money)€", attributes: [NSAttributedString.Key.foregroundColor: UIColor.green]))
        ...
        default:
            ...
            expense_string.append(NSAttributedString.init(string: "\(money)€", attributes: [NSAttributedString.Key.foregroundColor: UIColor.red]))
