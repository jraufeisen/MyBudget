...
class SubcriptionTypeBLTNItem: FeedbackPageBLTNItem {

    let dataSource: SubscriptionDurations
...
extension SubcriptionTypeBLTNItem: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
