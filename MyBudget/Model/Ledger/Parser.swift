...
class Parser: NSObject {
    ...
    */
    class func parseAccounts(ledgerString: String) -> [Account] {
        ...
        var lines = ledgerString.split(separator: "\n")
     ...
     */
    class func parseTransactions(ledgerString: String) -> [LedgerTransaction] {
        var lines = ledgerString.split(separator: "\n")
        ...
        for i in 0..<lines.count {
            ...
            if Int(firstCharacter) != nil {
                ...
                if (txBlockStart == nil) {
                    ...
                    if let single_tx = LedgerTransaction.init(ledgerString: transactionString) {
                        tx.append(single_tx)
                    }
                    txBlockStart = i
                }
    ...
    */
    class func parseDateFromLine(line: String) -> Date? {
        ...
        guard !testStr.isEmpty else {return nil}
